package com.Clas;
//xắp xếp mảng lớn đã gần hoàn chỉnh ;
// link https://www.youtube.com/watch?v=PgBzjlCcFvc
// so sánh phần tử dầu tiên với phần tử cuối cùng, nếu false thì giữ nguyên tiếp tục;
// nếu đúng thì cho nó xắp xếp vào mảng vs vị trí gắn vs vòng lặp như i =1;
// sai thì nó ko gắn vào;
// so sánh logic và xắp xếp mảng;
